...
for num in numList:
    ...
    tempScore = tempPart[0]+tempPart[1]+tempPart[2]+tempPart[3]\
                + tempPart[0].multiply(tempPart[1])/5 + tempPart[0].multiply(tempPart[2])/5\
                + tempPart[0].multiply(tempPart[3])/5 + tempPart[1].multiply(tempPart[2])/5\
                + tempPart[1].multiply(tempPart[3])/5 + tempPart[2].multiply(tempPart[3])/5\
                + tempPart[0].multiply(tempPart[1].multiply(tempPart[2]))/25\
                + tempPart[0].multiply(tempPart[1].multiply(tempPart[3]))/25\
                + tempPart[0].multiply(tempPart[2].multiply(tempPart[3]))/25\
                + tempPart[1].multiply(tempPart[2].multiply(tempPart[3]))/25\
                + tempPart[0].multiply(tempPart[1].multiply(tempPart[2].multiply(tempPart[3])))/125
